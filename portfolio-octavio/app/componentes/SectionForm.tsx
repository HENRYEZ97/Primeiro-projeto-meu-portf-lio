  ...
  return (
    <section id="contato" className="relative py-20 px-6 text-center bg-gradient-to-b from-black to-neutral-900">
      ...
      <form className="max-w-lg mx-auto mt-10 flex flex-col gap-4 bg-white/5 backdrop-blur border border-white/10 text-white p-4 rounded-xl focus:border-blue-600 focus:ring-2 focus:ring-blue-600/30 transition">
        <input type="text" placeholder="Nome:" required className="bg-neutral-900 text-white p-4 rounded-lg outline-none focus:ring-2 focus:ring-cyan-600/40 transition" />
          <input type="email" placeholder="E-mail:" required className="bg-neutral-900 text-white p-4 rounded-lg outline-none focus:ring-2 focus:ring-cyan-600/40 transition" />
            <input type="text" placeholder="Celular:" className="bg-neutral-900 text-white p-4 rounded-lg outline-none focus:ring-2 focus:ring-cyan-600/40 transition" />
              <textarea placeholder="Sua mensagem:" required className="bg-neutral-900 text-white p-4 rounded-lg h-28 outline-none focus:ring-2 focus:ring-cyan-600/40 transition" />
